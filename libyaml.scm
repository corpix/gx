...
(define-const YAML_WRITER_ERROR)
...
(c-define-type void* (pointer void (void*)))
(c-define-type size_t* (pointer size_t (size_t*)))
...
(define-c-lambda ffi_make_size_ptr () size_t*
  "___return ((size_t*) malloc (sizeof (size_t)));")
(define-c-lambda ffi_size_ptr_value (size_t*) size_t
  "___return (*___arg1);")
...
(c-define-type yaml_str_t (pointer unsigned-char))
(define-c-lambda make_yaml_str (size_t) yaml_str_t
  "___return (malloc ((___arg1 * sizeof (unsigned char)) + 1));")
(define-c-lambda yaml_str_value (yaml_str_t) UTF-8-string
  "___return (___arg1);")
(define-c-lambda yaml_str_set (yaml_str_t int int size_t) void
  "memset ((___arg1 + ___arg2), ___arg3, ___arg4);")
(define-c-lambda yaml_str_dup (UTF-8-string) yaml_str_t
  "___return (strdup (___arg1));")
(define-c-lambda yaml_str_free (yaml_str_t) void
...
(define-c-lambda yaml_emitter_set_output_string (yaml_emitter_t* yaml_str_t size_t size_t*) void
